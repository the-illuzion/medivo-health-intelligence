...
export default function DoctorPortalPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0b1726] text-slate-900 dark:text-white transition-colors duration-200">
      {/* Navigation Header */}
      <header className="h-20 border-b border-slate-200 dark:border-[#243d5c] bg-white/80 dark:bg-[#112236]/80 backdrop-blur-md px-8 flex items-center justify-between sticky top-0 z-40">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-sky-600 dark:text-sky-400 font-bold uppercase tracking-wider">Dermatologist Dashboard</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 bg-sky-500/10 border border-sky-500/30 text-sky-600 dark:text-sky-400 px-3 py-1.5 rounded-xl text-xs font-semibold">
            <ShieldCheck className="w-4 h-4" />
            <span>HIPAA Verified MD</span>
          </div>

          <div className="flex items-center gap-3 pl-4 border-l border-slate-200 dark:border-[#243d5c]">
      ...
      <main className="max-w-7xl mx-auto p-8 gap-8 flex flex-col">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <div className="bg-white dark:bg-[#112236] p-6 rounded-3xl border border-slate-200 dark:border-[#243d5c] shadow-sm">
            ...
            <p className="text-xs text-sky-600 dark:text-sky-400 font-semibold mt-1">3 Completed</p>
          </div>
          ...
          <div className="bg-white dark:bg-[#112236] p-6 rounded-3xl border border-slate-200 dark:border-[#243d5c] shadow-sm">
            ...
            <p className="text-xs text-sky-600 dark:text-sky-400 font-semibold mt-1">Ready for Call</p>
          </div>
        ...
        {/* Schedule List */}
        <div className="bg-white dark:bg-[#112236] rounded-3xl border border-slate-200 dark:border-[#243d5c] p-6 shadow-sm">
          ...
          <div className="divide-y divide-slate-200 dark:divide-[#243d5c]">
            {appointments.map((apt) => (
              <div key={apt.id} className="py-4 flex items-center justify-between first:pt-0 last:pb-0">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-2xl bg-sky-500/10 flex items-center justify-center font-bold text-sky-600 dark:text-sky-400 text-xs border border-sky-500/20">
                ...
                <div className="flex items-center gap-4">
                  <span className="text-xs font-bold px-3 py-1 rounded-full bg-slate-100 dark:bg-[#182d46] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-[#243d5c]">
                    {apt.time}
                  </span>
                  <button className="bg-sky-600 hover:bg-sky-500 text-white text-xs font-bold px-4 py-2 rounded-xl transition-colors flex items-center gap-1.5 shadow-sm">
