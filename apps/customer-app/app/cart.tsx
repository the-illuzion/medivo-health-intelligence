...
import { ArrowLeft, ShoppingBag, Trash2, ArrowRight, ShieldCheck, Tag } from 'lucide-react-native';
      ...
      <View className="px-6 pt-10 lg:pt-6 pb-6 bg-slate-50 dark:bg-[#111827] border-b border-slate-200 dark:border-[#374151] shadow-sm">
        <View className="max-w-7xl mx-auto w-full flex-row items-center justify-between">
          <View className="flex-row items-center">
            ...
            <View>
              <Text className="text-slate-900 dark:text-white text-2xl font-extrabold">Shopping Cart</Text>
              <Text className="text-slate-600 dark:text-slate-400 text-xs mt-0.5">2 Items Matched to your Skin Telemetry</Text>
            </View>
          </View>
          <Badge label="Free Express Shipping" variant="success" />
        </View>
      </View>
